 ...
 */
final class Version20220713072358 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE empleado_rol_empleado DROP FOREIGN KEY FK_48A2E5237DE6ECEA');
        $this->addSql('ALTER TABLE empleado_rol_roles DROP FOREIGN KEY FK_B0ECDB067DE6ECEA');
